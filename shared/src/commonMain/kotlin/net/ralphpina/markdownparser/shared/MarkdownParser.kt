...
// bold, italic, underline and hyperlinks
sealed class Entity(
    val start: Int,
    val end: Int
) {
...
private fun parseHyperlink(openIndex: Int, currentIndex: Int, sanitizedIndex: Int, source: String, entities: MutableList<Entity>): Int =
